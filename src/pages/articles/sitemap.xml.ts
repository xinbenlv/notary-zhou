...
export const GET: APIRoute = async () => {
  ...
  return new Response(sitemapUrlset([{ url: `${siteConfig.url}/articles/` }, { url: `${siteConfig.url}${topicPath('zh')}` }, ...entries]), {
